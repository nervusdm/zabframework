...
$GLOBALS["error_msg"] = array(
	...
	// root
	"home"			=> "A gyÃ¶kÃ©rkÃ¶nyvtÃ¡r nem lÃ©tezik, ellenÅ‘rizd a beÃ¡llÃ­tÃ¡sokat.",
	...
	// access
	"accessdir"		=> "Nem engedÃ©lyezett a szÃ¡modra az ehhez a kÃ¶nyvtÃ¡rhoz valÃ³ hozzÃ¡fÃ©rÃ©s.",
	"accessfile"		=> "Nem engedÃ©lyezett a szÃ¡modra az ehhez a fÃ¡jlhoz valÃ³ hozzÃ¡fÃ©rÃ©s.",
	"accessitem"		=> "Nem engedÃ©lyezett a szÃ¡modra az ehhez az elemhez valÃ³ hozzÃ¡fÃ©rÃ©s.",
	"accessfunc"		=> "Ennek a funkciÃ³nak a hasznÃ¡lata nem engedÃ©lyezett a szÃ¡modra.",
	...
	"searchnothing"		=> "Meg kell adnod a keresendÅ‘ kulcsszÃ³t.",
	...
	"miscselitems"		=> "Nem vÃ¡lasztottÃ¡l ki egy elemet sem.",
	"miscdelitems"		=> "Biztosan tÃ¶rÃ¶lni akarod ezt a(z) {0} elemet?",
	"miscdeluser"		=> "Biztosan tÃ¶rÃ¶lni akarod a kÃ¶vetkezÅ‘ felhasznÃ¡lÃ³t: '{0}'?",
	"miscnopassdiff"	=> "Az Ãºj jelszÃ³ ugyanaz, mint a jelenlegi.",
	"miscnopassmatch"	=> "EltÃ©rÅ‘ek a jelszavak.",
	"miscfieldmissed"	=> "KihagytÃ¡l egy fontos mezÃµt.",
	"miscnouserpass"	=> "Ã‰rvÃ©nytelen a felhasznÃ¡lÃ³nÃ©v vagy a jelszÃ³.",
	"miscselfremove"	=> "SajÃ¡t magadat nem tÃ¡volÃ­thatod el.",
...
$GLOBALS["messages"] = array(
	...
	'confirm_delete_file' => 'Biztosan tÃ¶rÃ¶lni akarod ezt a fÃ¡jlt? \\n%s',
	...
	'siphpupdate'		=> 'INFORMÃCIÃ“: <span style="color: red;">Az Ã¡ltalad hasznÃ¡lt PHP verziÃ³ <strong>elavult</strong>!</span><br />A Mambo Ã©s kiegÃ©szÃ­tÅ‘i valamennyi funkciÃ³inak Ã©s szolgÃ¡ltatÃ¡sainak biztosÃ­tÃ¡sÃ¡hoz<br />legalÃ¡bb <strong>PHP 4.3-as verziÃ³t</strong> kell hasznÃ¡lnod!',
	...
	'sidirpermsmess'	=> 'Ha azt akarod, hogy a '.$_VERSION->PRODUCT.' Ã¶sszes funkciÃ³ja Ã©s szolgÃ¡ltatÃ¡sa megfelelÅ‘en mÅ±kÃ¶djÃ¶n, akkor Ã­rhatÃ³vÃ¡ kell tenned a kÃ¶vetkezÅ‘ kÃ¶nyvtÃ¡rakat [chmod 0777]',
	'sionoff'			=> array( 'Be', 'Ki' ),
	
	'extract_warning' => "ValÃ³ban ki akarod bontani ezt a fÃ¡jlt? Ide?\\nFelÃ¼l fogja Ã­rni a lÃ©tezÅ‘ fÃ¡jlokat, ha nem kÃ¶rÃ¼ltekintÅ‘en hasznÃ¡lod!",
	...
	'already_bookmarked' => 'Ehhez a kÃ¶nyvtÃ¡rhoz mÃ¡r helyeztÃ©l el kÃ¶nyvjelzÅ‘t',
	...
	'enter_alias_name' => 'KÃ©rjÃ¼k, hogy Ã­rd be a kÃ¶nyvtÃ¡r aliasnevÃ©t',
	...
	'ftp_login_lbl' => 'KÃ©rjÃ¼k, hogy Ã­rd be az FTP kiszolgÃ¡lÃ³ hitelesÃ­tÃ©si adatait',
	...
	'ftp_connection_failed' => "Nem lehet kapcsolÃ³dni az FTP kiszolgÃ¡lÃ³hoz. \nKÃ©rjÃ¼k, ellenÅ‘rizd, hogy mÅ±kÃ¶dik-e az FTP kiszolgÃ¡lÃ³ a szerveren.",
	'ftp_login_failed' => "Sikertelen az FTP bejelentkezÃ©s. KÃ©rjÃ¼k, hogy ellenÅ‘rizd a felhasznÃ¡lÃ³nevet Ã©s a jelszÃ³t, majd prÃ³bÃ¡ld Ãºjra.",
	...
	'actlogin_failure' => 'A bejelentkezÃ©s nem sikerÃ¼lt, prÃ³bÃ¡ld Ãºjra.',
	...
	'aboutlink' => 'NÃ©vjegy...',
	'password_warning_title' => 'Fontos - VÃ¡ltoztasd meg a jelszavadat!',
	'password_warning_text' => 'A felhasznÃ¡lÃ³i fiÃ³k, melybe bejelentkeztÃ©l (admin admin jelszÃ³val) megegyezik az alapÃ©rtelmezÃ©s szerinti eXtplorer engedÃ©lyezÃ©sÅ± fiÃ³kÃ©val. Az eXtplorer telepÃ­tÃ©sed Ã­gy nyitott a betolakodÃ³k szÃ¡mÃ¡ra, ezÃ©rt javÃ­tsd azonnal ezt a biztonsÃ¡gi rÃ©st!',
	'change_password_success' => 'A jelszavad megvÃ¡ltozott!',
	'success' => 'Siker',
	'failure' => 'Sikertelen',
