<?
$file_information = File::getFileInformation($root_path.$path);
...
$file_perms_letters = File::getPermsLetters($root_path.$path);

$is_image = File::isFileType($root_path.$path,'image') ? true : false;

if($file_type == "dir") {
	$dir_information = File::getDirInformation($root_path.$path);
