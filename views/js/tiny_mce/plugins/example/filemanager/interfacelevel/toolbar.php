<div id="toolbar"> 
  <div id="toolbaritems" class="toolbaritems"> 
		...
		<nobr> 
			...
			if($php_file_name != "filelist.php") {	
				...
				if(!empty($path))
					...
					<a id="upfolder" class="mceButtonDisabled" href="javascript:window.location=\''.$php_file_name.'?path='.File::getFileDirName($path).'&'.$url_vars.'\'" onmousedown="return false;" onMouseOver="showToolbarItem(this,\'upfolder\',\'Up Folder\');" onMouseOut="hideToolbarItem();"><img src="images/toolbaritems/upfolder.gif" alt="Up Folder" title="Up Folder"  border="0" width="20" height="20" /></a>';
			}
			?>
		</nobr> 
	</div> 
    <div style="float: right"> 
		<nobr> 
			...
			<?
			if($php_file_name == "filelist.php") 
				echo '<a id="imagemanager" class="mceButtonDisabled" href="javascript:execFileCommand(\'imagemanager\',\''.$path.'\');" onmousedown="return false;" onMouseOver="showToolbarItem(this,\'imagemanager\',\'Thumbnails\');" onMouseOut="hideToolbarItem();"><img src="images/toolbaritems/tool_imagemanager.gif" alt="Switch to Image Manager" title="Switch to Image Manager" border="0" width="20" height="20" /></a>';
			else
				echo '<a id="filemanager" class="mceButtonDisabled" href="javascript:execFileCommand(\'filemanager\',\''.$path.'\');" onmousedown="return false;" onMouseOver="showToolbarItem(this,\'filemanager\',\'File Details\');" onMouseOut="hideToolbarItem();"><img src="images/toolbaritems/tool_filemanager.gif" alt="Switch to File Manager" title="Switch to File Manager" border="0" width="20" height="20" /></a>';
  ...
  <div class="filelistPath" title="/"><? 
  	$root_path_name = $CONFIG['root_path_name'] ? $CONFIG['root_path_name'] : ".";
