...
<head>
	...
	<?
	require_once("./../logiclevel/upload_ll.php");
	...
	echo '<script language="javascript" type="text/javascript">
		...
		var uploadInvalidExtensionMSG = "Error: Invalid extension! \n\nValid extensions are:\n '.$uploadExtensions.'.";
...
<body onload="init(3);">
<form id="uploadForm" name="uploadForm" method="post" action="upload.php?path=<? echo $path."&".$url_vars;?>" enctype="multipart/form-data" onsubmit="return validateForm(this);">
