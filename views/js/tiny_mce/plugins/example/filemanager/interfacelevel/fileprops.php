...
<body onload="init();">
<?
require_once("./../logiclevel/fileprops_ll.php");

$disabled = $CONFIG['chmod_available'] ? "" : "disabled";
?>
<form name="fileprops" method="post" action="fileprops.php?path=<? echo $path."&".$url_vars;?>" onsubmit="return validateForm(this);">
