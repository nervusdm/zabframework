...
<body onload="init();">
<?
require_once("./../logiclevel/createdoc_ll.php");
?>
<form id="createdoc" name="createdoc" method="post" action="createdoc.php?path=<? echo $path."&".$url_vars;?>" onsubmit="return validateForm(this);">
