...
<head>
	...
	_backend_url = "<?php print $IMConfig['backend_url']; ?>";
		...
		<link href="<?php print $IMConfig['base_url'];?>styles/editor.css" rel="stylesheet" type="text/css" />	
	<script type="text/javascript" src="<?php print $IMConfig['base_url'];?>scripts/slider.js"></script>
	<script type="text/javascript" src="<?php print $IMConfig['base_url'];?>scripts/editor.js"></script>
</head>
...
<div id="tools">
	...
	<div id="tools_save" style="display:none;">
		<div id="tool_inputs">
			...
			<label for="save_fileoverwrite">Overwrite:</label><input type="checkbox" id="save_fileoverwrite" checked/>
			<select name="format" id="save_format" style="margin-left: 10px; margin-right: 10px; vertical-align: middle;" onchange="updateFormat(this)">
...
<div id="contents">
<iframe id="editor" name="editor" width="100%" height="100%" src="<?php print $IMConfig['backend_url']; ?>__function=editorFrame&img=<?php if(isset($_GET['img'])) echo str_replace("%2F","/",rawurlencode($_GET['img'])); ?>" scrolling="auto" title="Image Editor" frameborder="0"></iframe>
</div>
<div id="bottom"></div>
</body>
</html>