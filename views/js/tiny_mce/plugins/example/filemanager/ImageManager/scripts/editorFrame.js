		...
		if(_1=="scale"){
			...
			if(_1=="rotate"){
				...
				if(_1=="save"){
					...
					var _41=topDoc.getElementById("save_fileoverwrite");
					...
					if(_4.value.length<=0){
						...
						var _2=_backend_url+"__function=editorFrame&img="+currentImageFile+"&action=save&params="+_7[0]+","+_9+"&file="+_8+"&fileoverwrite="+_10;
						location.href=_2;
					}
				}
			}
