<?
require_once("./../config/useraccesscontrol/group4/config.php");
require_once("./../config/useraccesscontrol/group4/config.file.allowed.php");
require_once("./../config/useraccesscontrol/group4/config.file.hidden.php");
