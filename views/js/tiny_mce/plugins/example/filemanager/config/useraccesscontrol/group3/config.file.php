<?
require_once("./../config/useraccesscontrol/group3/config.php");
require_once("./../config/useraccesscontrol/group3/config.file.allowed.php");
require_once("./../config/useraccesscontrol/group3/config.file.hidden.php");
