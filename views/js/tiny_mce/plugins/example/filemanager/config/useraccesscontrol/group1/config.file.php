<?
require_once("./../config/useraccesscontrol/group1/config.php");
require_once("./../config/useraccesscontrol/group1/config.file.allowed.php");
require_once("./../config/useraccesscontrol/group1/config.file.hidden.php");
