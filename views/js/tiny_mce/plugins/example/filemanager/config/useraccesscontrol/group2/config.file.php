<?
require_once("./../config/useraccesscontrol/group2/config.php");
require_once("./../config/useraccesscontrol/group2/config.file.allowed.php");
require_once("./../config/useraccesscontrol/group2/config.file.hidden.php");
