<?
require_once("./../config/useraccesscontrol/group5/config.php");
require_once("./../config/useraccesscontrol/group5/config.file.allowed.php");
require_once("./../config/useraccesscontrol/group5/config.file.hidden.php");
