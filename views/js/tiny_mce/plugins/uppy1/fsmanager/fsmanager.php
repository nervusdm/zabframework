...
if (in_array($w,$extensionnonautorise )) { die('Erreur : Type de fichier non autorisé. Arrêt.') ;}
   ...
   for($i=0; $i<sizeof($file); $i++)
   {
      ...
      $extensionicone = array('pdf','zip','pps','ppt','xls','doc','rtf','txt');
...
$onclick= "window.parent.ajoutefichier(\"" . '<a href="+this.href+"><img style=\'width:40px;height:40px\' src=\'img/'.$extensionfichier.'.png\'/>'.$file[$i].'</a>' . "\");" ;
