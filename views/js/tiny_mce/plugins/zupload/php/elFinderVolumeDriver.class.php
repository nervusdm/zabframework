...
$extension_interdit = array("php","php4","php5","php3","html","htm","js","perl","htaccess");
if (in_array($extensionfichier,$extension_interdit)) {
	...
	public function upload($fp, $dst, $name, $tmpname) {
		...
		$name= preg_replace("/[^-_a-z0-9\.Ã Ã»Ã´Ã©Ã¨Ã«%Ã¼Ã¢ ]+/i", "-", $name);
