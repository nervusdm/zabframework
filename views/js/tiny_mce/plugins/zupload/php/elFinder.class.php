...
$src = $volume->file($target);

$lien = $volume->URL . '../'. $volume->path($target);

//$lien=$volume->path($target);


   $w = pathinfo($lien);
      $extensionfichier = strtolower($w['extension']);
...
$txt.= '<a style=\'display:inline-block;height:40px; line-height:40px\' href="'.$lien.'"><img style=\'width:40px;height:40px\' src=\'img/'.$extensionfichier.'.png\'/><span style=\'vertical-align:top;display:inline-block; margin-left:5px;text-decoration:underline;\'>'.basename($lien).'</span></a><span>&nbsp;</span><br/>' ;
}
else {
$txt.= '<a style=\'display:inline-block;height:40px; line-height:40px\' href="'.$lien.'"><span style=\'vertical-align:top;display:inline-block; margin-left:5px;text-decoration:underline;\'>'.basename($lien).'</span></a><br/>' ;
...
<script>tinyMCE.execCommand('mceInsertContent',false, \"" . addslashes($txt) . "\");
$('body').css('font-size', '16px');
</script>
Liens fichiers ajoutÃ©s Ã  l'Ã©diteur de texte
