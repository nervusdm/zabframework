 ...
 */ (function (a) {
    window.elFinder = function (b, c) {
        ...
        a.extend(a.ui.keyCode, {
            ...
            var c = {
                ...
                title: d.i18n(d.i18n("Information")),
                resizable: !1,
                destroyOnClose: !0,
                buttons: {}
            };
            ...
            }, d.dialog('<span class=" "/>' + d.i18n(b.data.error), c)
        ...
        contextmenu: {
            ...
            files: ["getfile", "|", "putin","open", "quicklook", "|", "download", "|", "copy", "cut", "paste", "duplicate", "|", "rm", "|", "edit", "rename", "resize", "|", "archive", "extract", "|", "info"]
        },
    ...
    },elFinder.prototype.commands.putin = function () {
        var b = this.fm;
        this.getstate = function (c) {
            var c = this.files(c),
                d = c.length;
